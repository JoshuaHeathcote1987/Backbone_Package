...
class RelationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$entry) {
            ...
            $modelName = Str::studly($request->local_table);
            $singularModelName = substr($modelName, 0, -1);
            $modelFilePath = app_path("Models/$singularModelName.php");
            ...
            if (!file_exists($modelFilePath)) {
                ...
                if ($insertPosition !== false) {
                    ...
                    file_put_contents($modelFilePath, $modifiedModelContent);
                }
            }
