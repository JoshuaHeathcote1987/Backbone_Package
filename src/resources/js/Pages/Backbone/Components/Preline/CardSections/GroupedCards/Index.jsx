export default function GroupedCards({ className }) {
    return (
        <>
                <div className={`grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 ${className}`}>
                    <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
                        ...
                        <a className="py-3 px-4 md:px-5 inline-flex justify-between items-center text-sm text-gray-600 border-t border-gray-200 hover:bg-gray-50 rounded-b-xl dark:border-gray-700 dark:text-gray-400 dark:hover:bg-slate-800" href="#">
                            View reports
