...
export default function MegaMenuCustom({ appName }) {
    return (
        <>
            <header className="flex flex-wrap md:justify-start md:flex-nowrap w-full bg-white text-sm py-3 md:py-0 dark:bg-gray-800">
                <nav className="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
                    <div className="relative md:flex md:items-center md:justify-between">
                        <div className="flex items-center justify-between">
                            <a className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">{appName}</a>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-10">
                                                <div className="md:col-span-3">
                                                    <div className="flex flex-col py-6 px-3 md:px-6">
                                                        <div className="space-y-4">
                                                            ...
                                                            <a className="flex gap-x-4 text-gray-800 hover:text-blue-600 dark:text-gray-200" href="#">
                                                                <svg className="flex-shrink-0 w-4 h-4 mt-0.5 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                                ...
                                                <div className="md:col-span-3">
                                                    <div className="flex flex-col py-6 px-3 md:px-6">
                                                        ...
                                                        <div className="mt-7 space-y-4">
                                                            <span className="mb-2 text-xs font-semibold uppercase text-gray-800 dark:text-gray-200">User</span>

                                                            <Link className="flex gap-x-4 text-gray-800 hover:text-blue-600 dark:text-gray-200" href="/login">
                                                                <FiLogIn className="flex-shrink-0 w-4 h-4 mt-0.5 text-gray-800 dark:text-gray-200" />
                                                                <div className="grow">
                                                                    <p>Login</p>
                                                                </div>
                                                            </Link>
                                                            ...
                                                            <a className="flex gap-x-4 text-gray-800 hover:text-blue-600 dark:text-gray-200" href="#">
                                                                <FiUserPlus className="flex-shrink-0 w-4 h-4 mt-0.5 text-gray-800 dark:text-gray-200" />
                                                                <div className="grow">
                                                                    <p>Register</p>
                                                                </div>
                                                            </a>
