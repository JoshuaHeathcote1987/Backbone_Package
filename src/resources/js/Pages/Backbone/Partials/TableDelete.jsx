...
export default function TableDelete({ tableName }) {

    function handleSubmit(e) {
        e.preventDefault();
        axios.delete(`/backbone/tables/${tableName}`)
    ...
    return (
        <>
            <div id="hs-danger-delete" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
                            ...
                            <div class="flex gap-x-4 md:gap-x-7">
                                ...
                                <div class="grow">
                                    ...
                                    <p class="text-gray-500">
                                        Permanently remove this table and all of its contents. This action is not reversible, so please proceed with caution.
                                    </p>
                                </div>
                            </div>
                        </div>
